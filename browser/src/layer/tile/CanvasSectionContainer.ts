...
class CanvasSectionObject {
	...
	constructor (options: SectionInitProperties) {
		...
		this.callbacks = {
			...
			onMultiTouchMove: options.onMultiTouchMove,
			onMultiTouchEnd: options.onMultiTouchEnd,
			onResize: options.onResize,
			onDraw: options.onDraw,
			onDrawArea: options.onDrawArea,
			onNewDocumentTopLeft: options.onNewDocumentTopLeft,
			onRemove: options.onRemove,
			onAnimationEnded: options.onAnimationEnded,
		};
	}
}
